...
public class FilaDeEspera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel23.setText("FILA DE ESPERA");
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        if((jTextFieldNomeAluno.getText().isEmpty())||(jTextFieldRgAluno.getText().isEmpty())||(jTextFieldIdade.getText().isEmpty())
            ...
            try {
                PreparedStatement pst=conecta.conn.prepareStatement("update FILADEESPERA set nome_aluno=?,nome_responsavel=?,"
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        // TODO add your handling code here:
        conecta.executaSQLExcluir("INSERT INTO ExALUNOS SELECT * FROM FILADEESPERA where NUMERODEINSCRICAO like'"+jTextFieldNumeroDeInscricao.getText()+"'");
        conecta.executaSQLExcluir("delete from FILADEESPERA where NUMERODEINSCRICAO='"+jTextFieldNumeroDeInscricao.getText()+"'");
    ...
    public void preencherTabelaAlunosModalidadeGeral(){
        //
        preencherTabela("select * from FILADEESPERA");           
    }
